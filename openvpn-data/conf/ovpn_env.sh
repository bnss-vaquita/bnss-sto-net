...
declare -x OVPN_CN=vpnserver.acme.com
...
declare -x OVPN_PUSH=()
declare -x OVPN_ROUTES=([0]="192.168.50.0/24")
declare -x OVPN_SERVER=192.168.50.0/24
declare -x OVPN_SERVER_URL=udp://vpnserver.acme.com
